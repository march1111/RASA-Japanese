...
JIEBA_CUSTOM_DICTIONARY_PATH = "tokenizer_mecab"


class JiebaTokenizer(Tokenizer, Component):
    name = "tokenizer_mecab"
    ...
    def load_custom_dictionary(path):
        ...
        for jieba_userdict in jieba_userdicts:
            logger.info("Loading Mecab User Dictionary at "
...
sentences = "蘋果公司正考量用一億元買下英國的新創公司"
sen = "his is Pidor モバイルドメインリストの最新版が欲しい"


print("=== Start Chinese =====")
tok = JiebaTokenizer()
word =  (tok.tokenize(sen))
